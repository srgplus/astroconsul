...
POST = {
    ...
    "subtitle": ("Copy your big3.me data, paste into Claude, get insights that generic horoscopes can't match"),
    "date": date(2026, 3, 23),
    "author": "Victoria",
    "status": "published",
    "intro": (
    ...
    "sections": [
        ...
        },
        {
            ...
            "body_html": (
                ...
                "of your big3.me transit page — Claude can read images.</p>" + _prompt_block(DAILY_PROMPT_EN)
            ),
        },
        {
        ...
        },
        {
            ...
            "body_html": (
                ...
                "personalized insights.</p>" + _prompt_block(WEEKLY_PROMPT_EN)
            ),
        },
        {
            ...
            "body_html": (
                ...
                + _prompt_block("What should I know about today based on these transits? Be practical and specific.")
        ...
        },
        {
            ...
            "body_html": (
                ...
                "Claude умеет читать изображения.</p>" + _prompt_block(DAILY_PROMPT_RU)
            ),
        },
        {
        ...
        },
        {
            ...
            "body_html": (
                ...
                "для максимально персонализированного прогноза.</p>" + _prompt_block(WEEKLY_PROMPT_RU)
            ),
        },
        {
            ...
            "body_html": (
                ...
                + _prompt_block(
                    "Что мне нужно знать о сегодняшнем дне на основе этих транзитов? Будь практичным и конкретным."
                )
    ...
    "keywords": (
        "transit reading,ai astrology,claude ai,personalized horoscope,big3.me,transit guide,astrology prompts,2026"
    ),
...
def main():
    ...
    with session_scope(settings) as session:
        ...
        existing = session.execute(select(NewsPostModel).where(NewsPostModel.slug == POST["slug"])).scalar_one_or_none()
