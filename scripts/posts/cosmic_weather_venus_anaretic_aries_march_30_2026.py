"""Daily cosmic weather post — March 30, 2026.

Venus at 29°47' Aries (anaretic degree) — final hours in Aries before entering Taurus, her home sign.
Saturn sextile Pluto EXACT (0.17°) at 5° Aries/Aquarius — structural transformation continues.
Mercury trine Jupiter (3.19°) — intuitive communication in water signs.
Moon opposition Mercury (3.46°) — mind vs. gut tension.
Saturn conjunct Neptune (3.21°) — dreams meet discipline in Aries.
Sun conjunct Saturn (4.43°, separating) — identity shaped by duty.
Waxing Gibbous Moon in Virgo (149.2°). All planets direct.

Usage:
  python scripts/publish_post.py scripts/posts/cosmic_weather_venus_anaretic_aries_march_30_2026.py
"""
