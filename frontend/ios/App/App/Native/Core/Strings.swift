...
private let enUI: [String: String] = [
    ...
    "settings.accountFooter": "Opens the account screen, where you can delete your account and manage your subscription.",
...
private let ruUI: [String: String] = [
    ...
    "settings.accountFooter": "Открывает страницу аккаунта: там можно удалить аккаунт и управлять подпиской.",
