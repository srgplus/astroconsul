...
private let enUI: [String: String] = [
    ...
    "settings.accountFooter": "Account deletion and subscription management open in the app's web view.",
...
private let ruUI: [String: String] = [
    ...
    "settings.accountFooter": "Удаление аккаунта и управление подпиской открываются в веб-версии внутри приложения.",
