...
export function TransitsTab({ activeProfileId, activeDetail, onTransitReport, initialReport, isPro = false, onPaywall }: TransitsTabProps & { onPaywall?: () => void }) {
        ...
        <div className="transit-result">
          ...
          {sortedAspects.length ? (
            <div className="aspect-cards-wrapper">
              ...
              {!isPro && !hidesPaidTier() && sortedAspects.length > 3 && (
